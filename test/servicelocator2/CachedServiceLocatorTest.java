...
public class CachedServiceLocatorTest {
    ...
    void getObjectReturnsDifferentImplementationOnFactories() {
        ...
        try {
            assertSame(ssl.getObject(InterfaceA.class), ssl.getObject(InterfaceA.class));
            assertSame(ssl.getObject(InterfaceB.class), ssl.getObject(InterfaceB.class));
            assertSame(ssl.getObject(InterfaceC.class), ssl.getObject(InterfaceC.class));
            assertSame(ssl.getObject(InterfaceD.class), ssl.getObject(InterfaceD.class));
        } catch (LocatorError e) {
            fail(e.toString());
        }
    }
